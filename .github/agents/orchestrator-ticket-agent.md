...
5. Wait for human response. Handle per `human-checkpoint.behaviour.md`.
6. On APPROVE: log and proceed to Stage 3.
...
NEXT STEPS:
  ...
  → Create MR/PR for human developer review

...
The agent must read from the bundle path specified in the orchestrator output.
...
* Preferred: `projects/<project-name>/artifacts/QA/documents/backlog-review-qa.docx`
* Fallback: `projects/<project-name>/artifacts/QA/documents/backlog-review-qa.md`
...
```json
{
  ...
  "summary": "AI-Based Question Generation",
  "description": "string",
  "labels": [],
  "components": [],
  "status": "Draft",
...
* one JSON file for each epic under `artifacts/QA/epics/<epic-name>/`
* one JSON file for each user story under `artifacts/QA/epics/<epic-name>/user-stories/`
* `backlog-review-qa.docx` or `backlog-review-qa.md` under `artifacts/QA/documents/`
